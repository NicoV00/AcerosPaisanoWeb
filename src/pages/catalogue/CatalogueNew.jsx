    ...
    () => [
      ...
      */
      ...
      },
      {
        ...
        description: "Armaduras cilíndricas fabricadas industrialmente, para cimentaciones de pilotes, listas para posicionar.",
        extended:
          "Fabricadas según los requerimientos del proyecto, están diseñadas para absorber los esfuerzos de tracción, flexión y torsión en cimentaciones profundas. Eliminan el armado manual en obra garantizando la geometría de la jaula y reduciendo los tiempos de la cimentación.",
      ...
      },
      {
        ...
        category: "Barras",
        title: "Pasadores",
        description: "Barras de acero liso cortadas a medida, diseñadas para transferir cargas entre losas de hormigón y permitir el movimiento por dilatación o contracción.",
        extended:
          "Permiten la transferencia de cargas entre losas, evitando escalonamientos. Producidos en equipos de alta precisión permiten obtener una calidad en el corte libre de defectos y una tolerancia dimensional estricta.",
      ...
      },
      {
        ...
        category: "Armaduras",
        title: "Trelizas",
        description: "Armaduras de sección triangular, electrosoldadas, para uso en prelosas, viguetas y elementos premoldeados.",
        extended:
